    ...
    <div>
      <div>
        ...
        <div className="container">
          ...
          <div>
            <div>
              <h3 className="text-2xl text-primary font-[600]">
                OUR SERVICE SCHEDULE
              </h3>

              <div className="grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-4 md:gap-8">
                <div>
                  <h3 className="text-2xl font-[600] text-trdcolor font-[Jost] py-4">
                    Weekly Program
                  </h3>
                  <div className="flex flex-col gap-2 py-2">
                    {weeklyActivities.map((item) => (
                      <div
                        className="grid grid-cols-3 justify-center items-center gap-4"
                        key={item.id}
                      >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 justify-center items-center gap-4 md:gap-8 py-12">
                <div className="pe-0 md:pe-20">
                  <h3 className="text-xl font-[600] text-trdcolor font-[Jost]">
                    Monthly Program
                  </h3>
                  <div>
                    <div className="flex flex-row gap-2 py-2 justify-between items-center">
                      <p className="font-[500] text-lg leading-5">
                        A Day with the Lord programme
                      </p>
                      <hr />
                    ...
                    <p>
                      ...
                      Libero molestias ex ipsum alias, debitis, exercitationem
                      quasi quis dolor sunt, praesentium totam optio autem.
                      Unde, dolore.
                    </p>
                  </div>
                  <div>
                  ...
                  <div>
                    <div className="flex flex-row gap-2 py-2 justify-between items-center">
                      <p className="font-[500] text-lg leading-5">
                        Prophetic Sunday Service with Prophetess S.I Ezekwe
                      </p>
                      <hr />
                      <Timbox timtype="9am - 3pm" />
                    </div>
          ...
          {/* <div className="w-full md:w-1/2 flex flex-col items-center gap-4 mx-auto text-center py-4">
            <h3 className="text-2xl text-center font-[600] font-[Jost]">
              TESTIMONIES
            </h3>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt
              dolorem error optio voluptatum ipsa architecto consectetur omnis
              esse odio totam.
            </p>
          </div> */}
          <TestyCard />
